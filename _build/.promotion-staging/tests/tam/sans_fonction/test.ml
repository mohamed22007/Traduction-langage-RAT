...
let%expect_test "testPointer" =
  runtam (pathFichiersRat^"testPointer.rat");
  [%expect.unreachable]
[@@expect.uncaught_exn {|
  ...
  Called from Rat__PasseCodeRatToTam.analyse_code_instruction in file "PasseCodeRatToTam.ml", line 170, characters 38-65
  ...
  Called from Sans_fonction_tam__Test.(fun) in file "tests/tam/sans_fonction/test.ml", line 93, characters 2-44
